...
func init() {
	ns :=
		beego.NewNamespace("/v1",
			...
			beego.NSNamespace("/user_index",
				beego.NSInclude(
					&controllers.UserIndexController{},
				),
			),
			...
			beego.NSNamespace("/problems",
				beego.NSInclude(
					&controllers.ProblemManageController{},
				),
			),
			beego.NSNamespace("/events",
				beego.NSInclude(
					&controllers.EventManageController{},
			...
			beego.NSNamespace("/participants",
				beego.NSInclude(
					&controllers.ParticipantManageController{},
				),
			),
		)
